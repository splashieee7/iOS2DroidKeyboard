...
Ships two ways: preinstalled on de-Googled GrapheneOS phones, and public releases (GitHub Releases, later F-Droid). So: **no Google Play Services, no Firebase, no analytics, no network.**
